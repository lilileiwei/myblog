        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="admin/updata_type" method="post">
                        <h3> 修改博客分类 </h3>
                        ...
                        <table cellpadding="1" cellspacing="1">
                            ...
                            foreach ($types as $index => $type) {
                                ...
                                <tr id="catalog_92334">
                                    ...
                                    <td class="name"><a href="editCatalog.htm"
                                                        title="点击修改博客分类"><?php echo $type->type_name; ?></a></td>
                                    <td class="num"><?php echo $type->num; ?></td>
                                    <td class="opts">
                                        <a href="admin/get_article_type" title="点击修改博客分类">修改</a>
                                        <a href="admin/delete_type" onclick="return delete_catalog(154693,92334);">删除</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
