        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogArticleManage">
                    ...
                    <div id="BlogOpts">
                        <a href="javascript:;" id="check_all">全选</a>&nbsp;|
                        <a href="javascript:;" id="cancel">取消</a>&nbsp;|
                        <a href="javascript:;" id="select_other">反向选择</a>&nbsp;|
                    ...
                    <ul>
                        ...
                        ?>
                        <li class="row_1">
                            <input class="check_input" name="article_id" value="<?php echo $article->article_id;?>" type="checkbox">
...
//        反向选择
        $('#select_other').on('click',function(){
            $(".check_input").each(function(i,n){
                n.checked = !n.checked;
            });
        });
//        取消
