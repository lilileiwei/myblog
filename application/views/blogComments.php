...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title><?php echo $loginedUser->username?>的博客</title>
...
<div class="MainForm BlogCommentManage">
  <h3>共有 <?php echo count($list)?> 篇博客评论，每页显示 2 个，共 1 页</h3>
  <ul>
      <?php foreach ($list as $result){?>
		...
		<div class="opts">
			...
			<a href="admin/delete_all_comment?commUser=<?php echo $result->user_id?>">删除此人所有评论</a>
			</span>
