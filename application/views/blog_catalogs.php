        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="admin/add_blog_catalog" method="post">
                        <h3> 添加博客分类 </h3>
                        ...
                        <span class="submit"><input value="添加&nbsp;»" tabindex="3" class="BUTTON SUBMIT" type="submit">
                        </span>
                    </form>
                        ...
                        <table cellpadding="1" cellspacing="1">
                            ...
                            foreach ($types as $index=>$type) {
                                ...
                                <tr id="catalog_92334">
                                    ...
                                    <td class="opts">
                                        <a href="admin/get_article_type?type_id=<?php echo $type->type_id?>" title="点击修改博客分类">修改</a>
                                        <a href="admin/delete_type?type_id=<?php echo $type->type_id?>" onclick="return delete_catalog(154693,92334);">删除</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
