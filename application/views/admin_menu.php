    ...
    <ul>
        <li class="caption">个人信息管理
            <ol>
                ...
                <li><a href="welcome/personal_information">编辑个人资料</a></li>
                <li><a href="welcome/change_pwd">修改登录密码</a></li>
                <li><a href="welcome/change_mood">网页个性设置</a></li>
            </ol>
        </li>
    </ul>
    <ul>
        <li class="caption">博客管理
            <ol>
                ...
                <li><a href="admin/blog_catalogs">博客设置/分类管理</a></li>
