...
class Comment_model extends CI_Model{
    ...
    public function get_comment($user_id){
        $sql="select c.*,u.username,a.title from t_article a,t_comment c,t_user u  where c.user_id = u.user_id and c.article_id = a.article_id and a.user_id=$user_id";
        return $this->db->query($sql)->result();
    }
    ...
    public function delete_all_comment($commUser,$user_id){
